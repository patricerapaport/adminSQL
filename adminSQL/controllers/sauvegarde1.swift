...
//  adminSQL
//
//  Created by Patrice Rapaport on 05/11/2019.
...
class sauvegarde1: parentWC {
    ...
    @IBOutlet weak var labelSauvergarde: NSTextField!
...
extension sauvegarde1 {
    ...
    func _finDeFichier () {
        ...
        DispatchQueue.main.async {
            self.labelSauvergarde.stringValue = "Sauvegarde terminée"
    ...
    func sauvegardeTable(_ table: TablesModel) {
        ...
        DispatchQueue.main.async {
            if self.jaugeDump.isHidden {
                self.labelSauvergarde.stringValue = "Table " + tblName
                self.labelSauvergarde.needsDisplay = true
